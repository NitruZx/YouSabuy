<div class="block rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
    <h5 class="mb-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
      @if (session('status'))
        <div class="mb-4 rounded-lg bg-success-100 px-6 py-3 text-base text-success-700" role="alert">
          {{ session('status') }}
        </div>
      @endif
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        @if ($reg->reg_status === 'accept')
            <span class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">Accepted</span>
        @elseif ($reg->reg_status === 'pending')
        ...
        @else
            <span class="bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300">Cancel</span>
        @endif
        </div>
...
data-te-target="#exampleModalNonInvasive"
data-te-ripple-init
data-te-ripple-color="light">
Cancel
</button>
...
<div
  ...
  <div
    ...
    <div class="text-black relative flex-auto p-4" data-te-modal-body-ref>
      Do you sure you want to cancel this registration?
    </div>
    <div
      ...
      <button
        type="button" wire:click="cancel({{ $reg->client_id }})"
        class="inline-block rounded bg-danger px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#dc4c64] transition duration-150 ease-in-out hover:bg-danger-600 hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:bg-danger-600 focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:outline-none focus:ring-0 active:bg-danger-700 active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(220,76,100,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)]"
        data-te-ripple-init
        data-te-ripple-color="light">
        Cancel
...
@elseif ($reg->reg_status === 'cancelled')
<button
type="button"
...
<div
  ...
  <div
    ...
    <div class="text-black relative flex-auto p-4" data-te-modal-body-ref>
      Do you sure you want to resume this registration?
    </div>
    <div
      class="flex flex-shrink-0 flex-wrap items-center justify-end rounded-b-md border-t-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
      <button
      ...
      <button
        type="button" wire:click="resume({{ $reg->client_id }})"
...
<div class="text-black relative flex-auto p-4" data-te-modal-body-ref>
  If you can cancel this registration, you can't be able to resume it. <br>
  Do you sure you want to cancel this registration?
</div>
<div
  class="flex flex-shrink-0 flex-wrap items-center justify-end rounded-b-md border-t-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
  ...
  <button
    type="button" wire:click="deleteReg({{ $reg->client_id }}, '{{ $reg->room_id }}')"
    class="inline-block rounded bg-danger px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#dc4c64] transition duration-150 ease-in-out hover:bg-danger-600 hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:bg-danger-600 focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:outline-none focus:ring-0 active:bg-danger-700 active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(220,76,100,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)]"
    data-te-ripple-init
    data-te-ripple-color="light">
    Cancel
